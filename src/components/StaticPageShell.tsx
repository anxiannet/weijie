...
import {BookOpen, Calendar, GraduationCap, Heart, Home, Info, UserSearch, Utensils} from 'lucide-react';
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
...
type StaticPageShellProps = {
  active: 'favorites' | 'guides' | 'schools' | 'food' | 'events' | 'people' | 'about';
  breadcrumb: string;
        ...
        <Sidebar variant="sidebar" className="border-r bg-sidebar">
          ...
          <SidebarContent className="p-4">
            <SidebarGroup>
              ...
              <SidebarMenu>
                <SidebarMenuItem>
                  <SidebarMenuButton asChild isActive={active === 'favorites'} tooltip="收藏">
                    <a href="/favorites">
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton asChild isActive={active === 'people'} tooltip="找人">
                    <a href="/people">
