...
export const metadata = {
  title: '留学指南',
  description: '新加坡留学租房、申请、落地和生活指南。',
};

export default function GuidesPage() {
  return (
    <StaticPageShell active="guides" breadcrumb="留学指南">
      <section className="overflow-hidden rounded-3xl border bg-card shadow-sm">
        <div className="p-6 md:p-10">
          <Badge className="rounded-md">留学指南</Badge>
          <h1 className="mt-5 font-headline text-4xl font-bold leading-tight md:text-5xl">新加坡留学生活指南</h1>
